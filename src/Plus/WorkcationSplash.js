...
export default function WorkcationSplash() {
  return (
        ...
        <div class="xl:max-w-6xl lg:mx-auto">
          <div class="lg:w-7/12 lg:pl-12 lg:pr-8">
            ...
            <div class="mt-8 lg:mt-0 lg:absolute lg:inset-y-0 lg:right-0 lg:w-5/12">
              <img
                class="h-56 w-full object-cover object-center sm:h-56 rounded-lg shadow-xl lg:inset-0 lg:h-full lg:object-left lg:shadow-none lg:rounded-none"
                src="https://images.unsplash.com/photo-1530426509291-d831d721c7b2?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=3736&q=80"
            ...
            <div class="mt-6">
              <a
                href="/"
                class="px-5 py-3 inline-block bg-indigo-500 hover:bg-indigo-400 rounded-lg text-white font-semibold tracking-wide uppercase shadow-lg"
              >
                Book your escape
              </a>
            </div>
